...
namespace Plusbe.Encrypt
{
    ...
    public static class RSAHelper
    {
        ...
        public static RSAKey GetRASKey(string keyInfo)
        {
            RSACryptoServiceProvider.UseMachineKeyStore = true;
            //声明一个指定大小的RSA容器

            CspParameters param = new CspParameters();
            param.KeyContainerName = keyInfo;
            RSACryptoServiceProvider rsaProvider = new RSACryptoServiceProvider(DWKEYSIZE, param);
