...
public class UICreateService 
{
    public static void CreatUIManager(Vector2 referenceResolution, CanvasScaler.ScreenMatchMode MatchMode, bool isOnlyUICamera, bool isVertical)
    {
        ...
        layerTmp.gameUILayerParent = goTmp.transform;
        ...
        rtTmp.anchoredPosition3D = Vector3.zero;
        rtTmp.sizeDelta = Vector2.zero;
        layerTmp.fixedLayerParent = goTmp.transform;
        ...
        rtTmp.anchoredPosition3D = Vector3.zero;
        rtTmp.sizeDelta = Vector2.zero;
        layerTmp.normalLayerParent = goTmp.transform;
        ...
        rtTmp.anchoredPosition3D = Vector3.zero;
        rtTmp.sizeDelta = Vector2.zero;
        layerTmp.topBarLayerParent = goTmp.transform;
        ...
        rtTmp.anchoredPosition3D = Vector3.zero;
        rtTmp.sizeDelta = Vector2.zero;
        layerTmp.popUpLayerParent = goTmp.transform;
        ...
        PrefabUtility.SaveAsPrefabAssetAndConnect(UIManagerGo, "Assets/" + Path, InteractionMode.AutomatedAction);

    }

    public static void CreatUI(string UIWindowName, UIType UIType,UILayerManager UILayerManager,bool isAutoCreatePrefab)
    {
        Debug.Log("CreatUI:" +UIWindowName);
        ...
        if (isAutoCreatePrefab)
        {
            ...
            FileTool.CreatFilePath(Application.dataPath + "/" + Path);
            PrefabUtility.SaveAsPrefabAssetAndConnect(uiGo, "Assets/" + Path, InteractionMode.AutomatedAction);
        }
    ...
    {
        string LoadPath = Application.dataPath + "/Scripts/Plusbe/Editor/res/UIWindowClassTemplate.txt";
        string SavePath = Application.dataPath + "/Scripts/PlusbeUI/" + UIWindowName + "/" + UIWindowName + ".cs";
