...
namespace PlusbeQuickPlugin.HttpService
{
    ...
    public class CommandDebugHttpService : IHttpService
    {
        public int ServicePort { get; set; }
        public string ServiceName { get { return "命令系统网页调试服务"; } }

        string templateHtml;
        
        public CommandDebugHttpService(int port)
        {
            ServicePort = port;
            templateHtml = Resources.Load<TextAsset>("templateCommand").text;
        }
